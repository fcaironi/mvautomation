...
exports.config = {
  ...
  afterScenario: async function (scenario) {
    ...
    await browser.navigateTo(process.env.BASE_URL + "logout");
  },
  /**
   *
  ...
  //       "packages/myVistage-Automation",
  //       "allure-results"
  //     ); //ruta local
  //     const allureGeneration = spawn("allure", [
  //       "generate",
  //       "--clean",
  //       allureResultsPath,
  //     ]); // comandos para ser ejecutados
  //     allureGeneration.on("close", () => {
  //       //se comenta para que no abra el reporte en maquinas sin allure
  //       //  const allureOpen = spawn('allure', ['serve']);//abre el reporte
  //       resolve();
  //     });
  //   });
  // },
